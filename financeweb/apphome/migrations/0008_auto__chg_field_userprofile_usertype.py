...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.usertype'
        db.alter_column(u'apphome_userprofile', 'usertype', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'UserProfile.usertype'
        db.alter_column(u'apphome_userprofile', 'usertype', self.gf('django.db.models.fields.CharField')(max_length=5))
