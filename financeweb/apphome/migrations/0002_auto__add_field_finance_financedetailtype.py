...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Finance.financedetailtype'
        db.add_column(u'apphome_finance', 'financedetailtype',
                      self.gf('django.db.models.fields.CharField')(default='payment', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Finance.financedetailtype'
        db.delete_column(u'apphome_finance', 'financedetailtype')
    ...
    models = {
        u'apphome.finance': {
            ...
            'financedetailtype': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'financeintro': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'financename': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'financetype': ('django.db.models.fields.CharField', [], {'default': "'-1'", 'max_length': '80'}),
