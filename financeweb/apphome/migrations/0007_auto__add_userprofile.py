...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'apphome_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('usertype', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('userimg', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'apphome', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'apphome_userprofile')
    ...
    models = {
        ...
        u'apphome.userprofile': {
            ...
            'usertype': ('django.db.models.fields.CharField', [], {'max_length': '5'})
        },
        u'auth.group': {
