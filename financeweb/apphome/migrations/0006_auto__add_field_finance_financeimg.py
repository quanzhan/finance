...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Finance.financeimg'
        db.add_column(u'apphome_finance', 'financeimg',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Finance.financeimg'
        db.delete_column(u'apphome_finance', 'financeimg')
